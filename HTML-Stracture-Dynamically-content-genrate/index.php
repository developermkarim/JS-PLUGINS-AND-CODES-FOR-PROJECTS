            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        // Prepare and execute a query to fetch suppliers
                    ...
                    <div class="card-body">
                        <form method="post" id="purchase-store">
                            @csrf
                            <table class="table-sm table-bordered" width="100%" style="border-color: hsl(0, 0%, 87%);">
                                <thead>
                                    <tr>
                                        <th>Category</th>
                                        <th>Product Name </th>
